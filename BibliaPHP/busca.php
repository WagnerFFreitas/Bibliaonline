...
<?php
        ...
        $total_paginas_sql = "SELECT COUNT(*) FROM tbbiblia_pt WHERE texto LIKE '% " . mysqli_real_escape_string($conn, $busca) . " %'";
...
$conn = mysqli_connect($servidor, $dbusuario, $dbsenha, $dbname);
mysqli_set_charset($conn, "utf8");
$sql2 = "SELECT * FROM tbbiblia_pt WHERE texto LIKE '% " . mysqli_real_escape_string($conn, $busca) . " %' LIMIT $offset, $numerodepagina";
